...
{
	var gameWidth:Int = 445; // Width of the game in pixels (might be less / more in actual pixels depending on your zoom).
	var gameHeight:Int = 668; // Height of the game in pixels (might be less / more in actual pixels depending on your zoom).
